...
| [docs/data-contract.md](docs/data-contract.md) | The CSV the two halves exchange |
| [docs/configuration.md](docs/configuration.md) | Every knob, and which ones cost you disk |
| [docs/outputs.md](docs/outputs.md) | What a run produces and how much space it needs |
| [docs/calgary-recalibration.md](docs/calgary-recalibration.md) | The Québec → Alberta re-calibration |
| [docs/known-issues.md](docs/known-issues.md) | Sharp edges, with workarounds |
| [docs/development.md](docs/development.md) | Tests, and the patches to vendored NREL code |
